            ...
            <div className="space-x-2 ">
                <DropdownMenu>
                    <DropdownMenuTrigger asChild>
                        <Button className="gap-1.5" aria-label="zoom" variant='ghost'><Search className="h-4 w-4" />
                ...
                <Button
                    onClick={() => setRotation((prev) => prev + 90)} variant='ghost' aria-label="rotate 90 degrees">
